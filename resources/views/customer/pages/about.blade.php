<x-layouts.customer :title="'OUR STORY & ABOUT US — ' . __('app.brand_name')" :description="'Discover the origins, clinical research standards (RS), and cellular biology behind BLUE ZONE Longevity & Cellular Health.'">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20 space-y-20 sm:space-y-28">
        ...
        <section class="max-w-4xl mx-auto text-center space-y-6">
            <span
                class="inline-block px-4 py-1.5 rounded-full bg-[#67B34A]/15 text-[#67B34A] text-xs font-black uppercase tracking-[0.3em] border border-[#67B34A]/30">
                {{ __('app.our_story_foundational_ethos') }}
            </span>

            <h1
                class="text-4xl sm:text-6xl md:text-7xl font-black text-[#031827] dark:text-[#F6F5EF] tracking-tight leading-tight">
                {{ __('app.bridging_centenarian_wisdom') }}
                <span class="text-[#0A4F78] dark:text-[#2A8FC2]">
                    {{ __('app.cellular_medicine') }}
                </span>.
            </h1>

            <p
                class="text-base sm:text-xl text-[#031827]/75 dark:text-[#F6F5EF]/75 font-medium leading-relaxed max-w-3xl mx-auto">
                {{ __('app.blue_zone_biological_inquiry') }}

                <strong class="text-[#0A4F78] dark:text-[#2A8FC2]">
                    {{ __('app.blue_zone_longevity_question') }}
                </strong>

                {{ __('app.blue_zone_formulation_description') }}
            </p>

            <div class="pt-4 flex items-center justify-center gap-4 flex-wrap">
                <a href="#research-standards"
                    class="px-8 py-4 rounded-full bg-[#0A4F78] hover:bg-[#062B49] text-white text-xs font-black uppercase tracking-widest transition-all shadow-xl hover:scale-105 btn-sheen">
                    {{ __('app.explore_rs_standards') }} ↓
                </a>

                <a href="{{ route('customer.shop') }}"
                    class="px-8 py-4 rounded-full border border-[#0A4F78]/30 hover:bg-[#0A4F78]/10 text-[#0A4F78] dark:text-[#2A8FC2] text-xs font-black uppercase tracking-widest transition-all">
                    {{ __('app.view_formulations') }}
                    <i class="fa-solid fa-arrow-right rtl:rotate-180 ml-1.5"></i>
                </a>
            </div>
        </section>
        ...
        <section
            class="relative rounded-3xl overflow-hidden shadow-xl dark:shadow-2xl border border-[#0A4F78]/15 dark:border-[#0A4F78]/20 bg-white dark:bg-[#031827] transition-colors">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center p-8 sm:p-14">
                ...
                <div class="lg:col-span-6 space-y-6 text-[#031827] dark:text-white">
                    ...
                    <span
                        class="text-xs font-mono font-bold text-[#589c3e] dark:text-[#67B34A] tracking-widest uppercase">
                        {{ __('app.laboratory_purity_sourcing') }}
                    </span>

                    <h2
                        class="text-3xl sm:text-4xl font-black tracking-tight leading-tight text-[#031827] dark:text-white">
                        {{ __('app.formulated_in_europe') }}
                    </h2>

                    <p class="text-sm text-[#031827]/80 dark:text-[#E8DCC4] leading-relaxed">
                        {{ __('app.sourcing_and_extraction_description') }}
                    </p>

                    <div
                        class="grid grid-cols-3 gap-4 pt-4 border-t border-[#0A4F78]/15 dark:border-white/15 text-center">

                        <div class="space-y-1">
                            <span class="text-2xl sm:text-3xl font-black text-[#589c3e] dark:text-[#67B34A]">
                                100%
                            </span>

                            <span class="block text-[10px] uppercase font-bold text-[#031827]/70 dark:text-white/70">
                                {{ __('app.bio_identical') }}
                            </span>
                        </div>

                        <div class="space-y-1">
                            <span class="text-2xl sm:text-3xl font-black text-[#0A4F78] dark:text-[#2A8FC2]">
                                0.0%
                            </span>
                        ...
                        <div class="space-y-1">
                            <span class="text-2xl sm:text-3xl font-black text-[#0A4F78] dark:text-[#E8DCC4]">
                                cGMP
                            </span>
                ...
                <div class="lg:col-span-6">
                    <div
                        class="relative rounded-2xl overflow-hidden shadow-xl border border-[#0A4F78]/10 dark:border-white/10 group">

                        <img src="{{ asset('assets/images/hero/hero-01.webp') }}"
                            alt="{{ __('app.blue_zone_botanical_science_visual') }}"
                        ...
                        <div
                            class="absolute inset-0 bg-gradient-to-t from-[#031827]/80 via-transparent to-transparent">
                        </div>

                        <div
                            class="absolute bottom-6 left-6 right-6 flex items-center justify-between text-xs text-[#031827] dark:text-white font-bold bg-white/90 dark:bg-[#031827]/80 backdrop-blur-md p-3.5 rounded-xl border border-[#0A4F78]/20 dark:border-white/10 shadow-lg">

                            <span>
                                {{ __('app.clinical_research_compound_verification') }}
                            </span>

                            <span class="text-[#589c3e] dark:text-[#67B34A] font-mono">
                                {{ __('app.hplc_verified') }}
    ...
    1. EDITORIAL HERO
    ========================================================== --}}
        <section class="max-w-3xl mx-auto text-center space-y-4" aria-labelledby="bz-science-hero-title">

            <span
                class="inline-block text-[11px] font-extrabold uppercase tracking-[0.3em]
                   text-[#0A4F78] dark:text-[#2A8FC2]">
                {{ __('app.our_science') }}
            </span>

            <h1 id="bz-science-hero-title"
                class="text-3xl sm:text-5xl md:text-6xl
                   font-light text-[#031827] dark:text-[#F6F5EF]
                   tracking-tight leading-tight">

                {{ __('app.where_longevity_meets') }}
            ...
            <p
                class="text-xs sm:text-base
                   text-[#031827]/75 dark:text-[#F6F5EF]/75
                   font-medium leading-relaxed max-w-2xl mx-auto">
                {{ __('app.science_hero_description') }}
            </p>
