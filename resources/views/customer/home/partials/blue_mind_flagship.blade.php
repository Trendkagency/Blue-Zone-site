...
@php
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    $mainProductImage = $mainProduct->image
        ...
        <div class="grid grid-cols-1 items-center gap-12 lg:grid-cols-12 lg:gap-16">
            ...
            <div class="lg:col-span-6">
                ...
                <div class="relative mx-auto w-full max-w-xl">
                    ...
                    {{-- Product frame --}}
                    <div
                        class="group relative aspect-square overflow-hidden rounded-[2rem] border border-[#0A4F78]/15 bg-[#F6F5EF] p-8 shadow-xl transition-all duration-500 hover:shadow-2xl dark:border-[#2A8FC2]/40 dark:bg-[#062B49]/80 sm:p-12"
                    >
                        ...
                        <div class="relative z-10 flex h-full w-full items-center justify-center">
                            <img
                                ...
                                loading="lazy"
                                decoding="async"
                                class="h-4/5 w-4/5 object-contain transition-transform duration-700 ease-out group-hover:scale-105"
                        ...
                        <div
                            class="absolute left-5 top-5 z-20 inline-flex items-center gap-2 rounded-xl border border-[#0A4F78]/20 bg-white/95 px-3 py-2 text-[10px] font-black uppercase tracking-wider text-[#0A4F78] shadow-sm backdrop-blur-md dark:border-[#2A8FC2]/50 dark:bg-[#031827]/90 dark:text-[#2A8FC2] sm:left-6 sm:top-6"
                        >
                        ...
                        <div
                            class="absolute bottom-5 right-5 z-20 inline-flex items-center gap-2 rounded-xl border border-[#67B34A]/40 bg-white/95 px-3 py-2 text-[10px] font-black uppercase tracking-wider text-[#589c3e] shadow-sm backdrop-blur-md dark:border-[#67B34A]/50 dark:bg-[#031827]/90 dark:text-[#67B34A] sm:bottom-6 sm:right-6"
                        >
            ...
            <div class="lg:col-span-6">
                ...
                <div class="max-w-2xl space-y-6">
                    ...
                    >
                        <span
                            class="h-1.5 w-1.5 rounded-full bg-[#2A8FC2]"
                            aria-hidden="true"
                        ></span>
                    ...
                    <div class="space-y-3">
                        ...
                        @if($tagline)
                            <p
                                class="text-base font-bold tracking-wide text-[#0A4F78] dark:text-[#2A8FC2] sm:text-lg"
                            >
                                {{ $tagline }}
                            </p>
                        @endif
                    ...
                    <div class="flex flex-wrap items-center gap-x-5 gap-y-3">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                >
                                    @for($star = 1; $star <= 5; $star++)
                                        <i
                                            class="fa-solid fa-star text-xs {{ $star <= round((float) $mainProduct->rating) ? 'text-[#F2B84B]' : 'text-[#CBD5E1]' }}"
                                            aria-hidden="true"
                                        ></i>
                                    @endfor
                                </div>
                        ...
                        @if($mainProduct->brand)
                            <span class="text-xs font-bold uppercase tracking-widest text-[#0A4F78]/60 dark:text-[#7EA5B8]">
                                {{ $mainProduct->brand }}
                            </span>
                        @endif
                            ...
                            <div class="flex flex-wrap gap-2">
                                ...
                                @foreach(array_slice($ingredients, 0, 6) as $ingredient)
                                    ...
                                    @php
                                        ...
                                        $ingredientDose = is_array($ingredient)
                                            ? ($ingredient['dose'] ?? null)
                                            : null;
                                    @endphp
                    ...
                    >
                        ...
                        <div class="min-w-[150px]">
                            ...
                            @if(
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <span class="rounded-md bg-[#67B34A]/10 px-2 py-0.5 text-[10px] font-black uppercase text-[#589c3e] dark:text-[#67B34A]">
                                        {{ $isRtl ? 'عرض' : 'Sale' }}
                                    </span>
                            ...
                            @if($mainProduct->product_size)
                                <span class="mt-1 block text-[10px] font-bold uppercase tracking-widest text-[#0A4F78]/60 dark:text-[#7EA5B8]">
                        ...
                        <div class="flex flex-1 flex-col gap-3 sm:flex-row">
                            ...
                            >
                                ...
                                <i
                                    class="fa-solid fa-arrow-right rtl:rotate-180"
                                    aria-hidden="true"
                                ></i>
                            </a>
