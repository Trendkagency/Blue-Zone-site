...
@section('title', app()->getLocale() === 'ar' ? 'تقييم الأداء' : 'Performance & Promotions')
@section('content')
<div style="padding:2rem;">
    <div style="display:flex;align-items:center;gap:1rem;margin-bottom:1.5rem;">
        <i class="fa-solid fa-chart-bar" style="font-size:2rem;color:var(--purple-400, #94a3b8);"></i>
        <div>
            <h1 style="font-size:1.5rem;font-weight:700;margin:0;">{{ app()->getLocale() === 'ar' ? 'تقييم الأداء' : 'Performance & Promotions' }}</h1>
