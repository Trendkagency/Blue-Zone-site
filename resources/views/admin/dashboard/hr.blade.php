...
>
    ...
    <div class="bz-hero-banner">
        <div class="relative z-10 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            ...
            <!-- Right Fast HR CTAs -->
            <div class="flex items-center gap-2.5 flex-wrap">
                <a href="{{ route('admin.users.create') }}" class="bz-hero-btn-primary">
                    <i class="fa-solid fa-user-plus"></i>
                    <span>{{ app()->getLocale() === 'ar' ? 'إضافة موظف جديد' : 'New Employee' }}</span>
                </a>

                <a href="{{ route('admin.users.index') }}" class="bz-hero-btn-secondary">
                    <i class="fa-solid fa-address-book text-purple-300"></i>
                    <span>{{ app()->getLocale() === 'ar' ? 'دليل الموظفين' : 'Staff Directory' }}</span>
                </a>

                <a href="{{ route('admin.roles.index') }}" class="bz-hero-btn-secondary">
