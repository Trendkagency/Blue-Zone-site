...
>
    ...
    <div class="relative overflow-hidden rounded-3xl bg-gradient-to-r from-[#062B49] via-[#0A4F78] to-[#15456E] text-white p-6 sm:p-7 mb-6 shadow-md border border-[#15456E]">
        ...
        <div class="absolute -left-16 -bottom-16 w-64 h-64 bg-amber-500/15 rounded-full blur-3xl pointer-events-none"></div>
        ...
        <div class="relative z-10 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            ...
            <div class="flex items-center gap-2.5 flex-wrap">
                <a href="{{ route('admin.mr.live-map') }}" class="btn font-black text-xs sm:text-sm px-4 py-2.5 rounded-xl shadow-md bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-600 hover:to-orange-700 text-white border-0 transition-all flex items-center gap-2">
                    <i class="fa-solid fa-earth-americas"></i>
                    <span>{{ app()->getLocale() === 'ar' ? 'خريطة العمليات الميدانية' : 'Live Ops Map' }}</span>
                </a>

                <a href="{{ route('admin.dashboard', ['view' => 'operations']) }}" class="btn font-bold text-xs sm:text-sm px-4 py-2.5 rounded-xl shadow-sm bg-white/15 hover:bg-white/25 text-white border border-white/20 transition-all flex items-center gap-2">
                    <i class="fa-solid fa-boxes-stacked text-emerald-300"></i>
                    <span>{{ app()->getLocale() === 'ar' ? 'لوحة العمليات' : 'Operations' }}</span>
                </a>

                <a href="{{ route('admin.dashboard', ['view' => 'hr']) }}" class="btn font-bold text-xs sm:text-sm px-4 py-2.5 rounded-xl shadow-sm bg-white/10 hover:bg-white/20 text-white border border-white/15 transition-all flex items-center gap-2">
