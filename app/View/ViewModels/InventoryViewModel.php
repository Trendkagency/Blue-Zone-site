...
class InventoryViewModel
{
    ...
    public static function locations(): array
    {
        return [
            ...
            ['id' => 'offline', 'name_en' => 'Warehouse / POS', 'name_ar' => 'المستودع الرئيسي / المبيعات المباشرة', 'code' => 'LOC-POS'],
    ...
    public static function stockItems(): array
    {
        return [
            ...
            [
                ...
                'variant_ar' => '60 كبسولة نباتية',
                'location_id' => 'offline',
                'location_name_en' => 'POS Warehouse',
    ...
    public static function movements(): array
    {
        return [
            ...
            [
                ...
                'date' => '2026-09-01',
                'time' => '18:40:02',
                'user' => 'Sarah Jenkins (Warehouse Specialist)',
